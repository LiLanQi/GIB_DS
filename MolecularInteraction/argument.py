...
def parse_args():
    ...
    parser.add_argument("--embedder", type=str, default="GIB_DS") #model name
    ...
    # train dataset, the name of dataset
    #parser.add_argument("--dataset", type = str, default = 'chr_abs', help = 'AP_dataset / CB_dataset / CHAB/ CHEM/CHALT/FS_dataset / CombiSolv/ TUM')
