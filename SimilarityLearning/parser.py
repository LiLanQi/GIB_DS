...
def parameter_parser():
    ...
    parser.add_argument('--embedder', type=str, default='GIB_DS', help='Specify the model')
    parser.add_argument("--dataset", nargs="?", default="openssl_min50", help="Dataset name. reg: AIDS700nef/LINUX/IMDBMulti and cls: ffmpeg_min3/20/50, openssl_min3/20/50")
    parser.add_argument("--epochs", type=int, default=10000, help="Number of training epochs. Default is 10000.")
    parser.add_argument("--batch-size", type=int, default=16, help="Number of graph pairs per batch. Default is 128.")
    ...
    if parser.parse_known_args()[0].embedder == "GIB_DS":
